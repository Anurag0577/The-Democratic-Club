    ...
    <div className={`border border-white/10 rounded-2xl bg-black/40 backdrop-blur flex flex-col h-full ${isMobile ? 'p-3' : 'p-6'} `}>
      <div className={isMobile ? 'mb-3' : 'mb-6'}>
        ...
        <input
          ...
          className={`w-full bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-lime-400/50 transition-colors duration-200 ${isMobile ? 'px-2 py-1.5 text-xs' : 'px-4 py-3 text-sm'}`}
        />
      </div>
